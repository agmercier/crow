...
{
    public class GlideUnlock : MonoBehaviour
    {
        ...
        void OnTriggerEnter2D(Collider2D other)
        {
            ...
            if (player != null)
            {
                ...
                //fetches Player Controller component from the player and sets 'GlideUnlocked' to true
                player.GetComponent<PlayerController>().glideUnlocked = true;
            }
        }
    }
}
